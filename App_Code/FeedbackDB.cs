...
public class FeedbackDB
{
    ...
    // method to get all feedacks  by rating from the database
    public static List<Feedback> getAllFeedbackOfRating (string rating)
    {
        List<Feedback> feedbackList = new List<Feedback>();
        try
        {
            SqlCommand command = new SqlCommand("SELECT * FROM Feedback WHERE rating = @rating");
            ...
            while (reader.Read())
            {
                ...
                readAFeedback(ref i, ref reader);
