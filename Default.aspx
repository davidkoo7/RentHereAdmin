    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon" onclick="location.href='ItemList.aspx';">
                    <div class="widget-item-left">
                        <span class="fa fa-shopping-cart"></span>
                    </div>
                    <div class="widget-data">
                        <div class="widget-int num-count">
                            <asp:Label ID="lblNumOfItem" runat="server" Text="Label"></asp:Label>
                        </div>
                        <div class="widget-title">NEW Items</div>
                    </div>
                    <div class="widget-controls">
                        <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span class="fa fa-times"></span></a>
                    </div>
            ...
            <div class="col-md-3">
                ...
                <div class="widget widget-default widget-item-icon" onclick="location.href='MemberList.aspx';">
                    <div class="widget-item-left">
                        <span class="fa fa-user"></span>
                    </div>
                    <div class="widget-data">
                        <div class="widget-int num-count">
                            <asp:Label ID="lblNumOfRegisteredUser" runat="server" Text="Label"></asp:Label>
                        </div>
                        <div class="widget-title">Registered users</div>
                        <div class="widget-subtitle">On RentHere</div>
                    </div>
                    <div class="widget-controls">
                        <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget"><span class="fa fa-times"></span></a>
                    </div>
