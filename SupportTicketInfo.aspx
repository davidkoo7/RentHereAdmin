<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SupportTicketInfo.aspx.cs" Inherits="SupportTicketInfo" %>
            ...
            <asp:Repeater ID="rptMemberInfoRedirect" runat="server">
                <ItemTemplate>
                    <div class="list-group list-group-contacts border-bottom push-down-10">
                        <a href="MemberInfo.aspx?memberID=<%#Eval("Member.memberID") %>" class="list-group-item">
                            <div class="list-group-status status-online"></div>
                            <img src="assets/images/users/user.jpg" class="pull-left" alt="Dmitry Ivaniuk">
                            <span class="contacts-title">
                                <asp:Label ID="lblMember" runat="server" Text='<%#Eval("Member.Name") %>'></asp:Label></span>
                            <p></p>
                            <asp:Label ID="lblMemberstatus" runat="server" Text='<%#Eval("Member.Status") %>'></asp:Label></p>
